    ...
    <>
      <div className="pad-left-right">
        <div className="hero ng-mr-80">
          <div className="title red item1">
            <span className="one center">why </span>
            <span className="two center">the </span>
            <span className="three center">long </span>
          </div>
          <div className="item2">
          ...
          <div className="item hero_desc">
            <div className="item">
              ...
              <p>
                ...
                original, unique, on-chain, algorithmically created NFT
                characters by the Rogues Collective.
              </p>
              <p>
              ...
              <p>
                Each has unqiue characteristics, some of which might make it
                rarer than others. Check out the rare feature on each WTLF, to
                get the rarer WTLF for yourself.
              </p>
            </div>
          </div>
      ...
      <section className="beta">
        <div className="hero">
          <div className="title red">
            <span className="one">Why is</span>
          </div>
          <div className="item2">
            <img src="/two.png" />
          </div>
        ...
        <div className="hero">
          <div className="title yellow item1">
            <span className="two">better than</span>
          </div>
          <div className="item2">
            <img src="/three.png" />
          </div>
        ...
        <div className="description">
          ...
          <p>
            ...
            However some characters have rarer elements than others (a Japanese
            Lacquered Comb above versus cornrows below). Naturally this has an
            effect on the price of the WTLF.
          </p>
      ...
      <section className="three">
        <div className="third-wrapper">
          <div className="grades">
            <h2>
              <span>Elemental rarity grades</span>
            </h2>
          ...
          <div className="flex grades-grid">
            ...
            <div className="right sz35 direction-col">
              <div className="lists">
                <ul>
                  <li>
